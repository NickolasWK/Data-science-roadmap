...
- [ ] Математика (**)
    - :white_check_mark: Линейная алгебра (*)
    - [ ] Математический анализ (* надо повторить)
    - :white_check_mark: Теория вероятностей (**)
    - :white_check_mark: Статистика (**)
    - [ ] Вычислительная статистика (***)
    - [ ] A/B тестирование (***)
- :white_check_mark: Python (**)
    - :white_check_mark: Основы языка (*)
    - :white_check_mark: ФП (**)
